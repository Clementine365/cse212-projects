...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: there a wrong re-que order found, the turns are not also decreasing in the correct order or correctly
    ...
    // Defect(s) Found: george is not inserted in the correct rotation
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:the codes treats 0 as not having a trun than giving Tim infinite turns 
    ...
    // Defect(s) Found: this code is treating forever as negative turns
